...
public abstract class ReunionGenerator {
    ...
    public static List<Reunion> LIST_REUNION = Arrays.asList(
            new Reunion("Rubis", "Sujet 1", "aurelie@wanadoo.fr , mamadou@caramail.net", "01/01/2020", "15:00", R.drawable.rubis_lens_24dp),
            new Reunion("Corail", "Sujet 2", "petitpoucet@monchemin.com", "05/03/2020", "11:00", R.drawable.corail_lens_4dp)
    );
